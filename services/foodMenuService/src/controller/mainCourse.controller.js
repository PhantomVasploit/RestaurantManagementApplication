...
module.exports.createMainCourseMenu = (req, res)=>{
    const data = [
      ...
      {name: "Chicken Tikka", price: 1700, "storeItem": ["Chicken", "Yoghurt", "Lemon", "Garlic", "Cloves", "Ginger", "Salt", "Ground Cumin", "Garam Masala", "Paprika", "Onions", "Tumeric", ], imgUrl: "https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Y2hpY2tlbiUyMHRpa2thfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"},
