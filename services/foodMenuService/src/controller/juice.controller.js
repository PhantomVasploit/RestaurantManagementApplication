...
module.exports.createJuiceMenu = (req, res)=>{
  const data = [
    ...
    {name: "Tropical Blend", price: 800, storeItem: ["Apple", "Pineapple", "Orange", "Grape", "Passion"], imgUrl: "https://images.unsplash.com/photo-1483918793747-5adbf82956c4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dHJvcGljYWwlMjBtaXglMjAlMjBqdWljZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"}
  ]
